...
//	func BookGetHandler(idParam string) func(http.ResponseWriter, *http.Request)
//	func BookUpdateHandler(idParam string) func(http.ResponseWriter, *http.Request)
//	func BooksListHandler() func(http.ResponseWriter,*http.Request)
//	func BooksCreateHandler() func(http.ResponseWriter,*http.Request)
//	func BookDeleteHandler(idParam string) func(http.ResponseWriter,*http.Request)
//}
...
func CreateEndPointFactory(bookStore *BookStoreClass) (*endPointFactory, error){
